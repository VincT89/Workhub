...
const OrdersTable = ({
  ...
  return (
    <div className="w-full rounded-3xl bg-[rgba(255,255,255,0.12)] backdrop-blur-xl p-6 shadow-md border-[2px] border-white/70 flex flex-col gap-4">
      {/* TOOLBAR */}
                            ...
                            <div className="flex-shrink-0 flex justify-center md:justify-start">
                              {row.prodottoDettaglio?.image && (
                                <img
                                  ...
                                  alt={row.prodottoDettaglio.name || "Immagine prodotto"}
                          ...
                          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                            {row.clienti.map((cliente) => (
                              ...
                              >
                                ...
                                <p className="text-xs md:text-sm">{cliente.email}</p>
                                ...
                                <div className="flex justify-between mt-3 items-center text-xs md:text-sm">
                                  ...
                                  <span>
                                    Tot:{" "}
                                    <strong>{formatEuro(cliente.totale)}</strong>
                                  </span>
                                </div>
                              </div>
                            ))}
