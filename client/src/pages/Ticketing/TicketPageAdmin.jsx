	...
	return (
		<div class="p-6 flex flex-col gap-4 h-full">
			...
			<div className="flex flex-col lg:flex-row gap-6">
				 ...
				 */}
				<div
					className="w-full lg:w-3/5 flex flex-col gap-6 rounded-xl sticky top-6 h-fit"
					style={{
              ...
              dataset={lineChartData}
               legend={{ hidden: true }}
				 ...
				 */}
				<div
					className="w-full lg:w-2/5 p-6 flex flex-col gap-4 rounded-xl border border-white/90 shadow-md backdrop-blur-sm sticky top-6 h-[580px] "
					style={{
						backgroundColor: theme === "dark" ? "#4d4368" : "transparent",
					}}
				>
					<h2 className="font-bold text-2xl mb-4 flex items-center gap-3 text-[#090c64]">
						<ListMagnifyingGlassIcon size={28} weight="duotone" />
						{t("listaTicket")}
					</h2>
