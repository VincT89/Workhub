  ...
  return (
    <div className="w-full h-full flex flex-col gap-8 overflow-y-auto scrollbar-thin scrollbar-thumb-[#1C62A0] scrollbar-track-transparent">
      ...
      <div
        className={`
          backdrop-blur-sm border border-white/30 rounded-[25px]
          shadow-md p-6 flex flex-col gap-6
          ${theme === "dark" ? "bg-white/20" : "bg-white/20"}
        `}
      >
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="bg-white/40 dark:bg-white/20 p-3 rounded-full shadow-sm">
              {customer.nome}
            </div>
            <div className="bg-white/40 dark:bg-white/20 p-3 rounded-full shadow-sm">
              {customer.indirizzo}
        ...
        <div className="w-full flex justify-end mt-4">
          <button
            className={`
              px-4 py-2 rounded-full shadow-sm border border-white
              hover:text-white transition cursor-pointer
              ${theme === "dark"
                ? "bg-white/20 hover:bg-[#1C62A0]/20"
                : "bg-white/60 hover:bg-[#1C62A0]"}
            `}
          >
