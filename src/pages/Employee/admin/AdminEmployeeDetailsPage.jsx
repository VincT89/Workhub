                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="bg-[#1C62A0] text-white text-sm px-3 py-1 rounded-full hover:bg-[#155293] font-semibold transition"
                    >
                      {t("employees.accetta")}
                    </button>
                    <button
                      onClick={() => handleRifiutaFerie(fe, anagrafica.nome)}
                      className="bg-white/30 dark:bg-white/10 text-[#1C62A0] text-sm px-3 py-1 rounded-full hover:bg-white/50 dark:hover:bg-[#1C62A0]/20 font-semibold transition"
                    >
                      {t("employees.rifiuta")}
                    </button>
                  </div>
